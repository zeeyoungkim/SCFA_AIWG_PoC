...
registration_modal = Modal("등록 완료", key="registration_modal", padding=20, max_width=450)
...
if register_button:
    if not phone.strip():
        ...
        registration_modal.open()

if registration_modal.is_open() and st.session_state.show_modal:
    with registration_modal.container():
